...
import com.victor.lib.common.databinding.ViewItemBinding
import com.victor.lib.common.databinding.ViewMultiSearchContainerBinding
import com.victor.lib.common.view.widget.searchview.KeyboardHelper.hideKeyboard
 ...
 * -----------------------------------------------------------------
 * File: MultiSearchContainerView
 * Author: Victor
 * Date: 2020/7/13 下午 04:41
 * Description: 
 * -----------------------------------------------------------------
 */
class MultiSearchContainerView @JvmOverloads constructor(
    ...
    private fun createNewSearchView(): ViewItemBinding {
        ...
        viewItem.root.layoutParams = LinearLayout.LayoutParams(searchViewWidth.toInt(),
