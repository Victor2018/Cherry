...
class EditUserActivity: BaseActivity() {
    ...
    override fun getLayoutResource() = R.layout.activity_edit_user
    ...
    override fun onResume() {
        super.onResume()
        switchFragment(currentFragment,EditUserFragment.newInstance())
    }
    ...
    fun switchFragment(fromFragment: Fragment?, toFragment: Fragment?) {
        ...
        if (toFragment?.isAdded()!!) {
            ...
            ft.add(R.id.edit_user_container, toFragment)
        }
